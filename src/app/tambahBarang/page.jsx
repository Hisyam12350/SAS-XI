        ...
        <form action={tambahBarang} className="space-y-4">
                            ...
                            <div>
                                <label htmlFor="kategori" className="block text-sm font-medium text-gray-700 mb-1">
                                    ...
                                    <select name="kategori" id="kategori" className="w-full px-3 py-2 border text-black border-black rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400">
